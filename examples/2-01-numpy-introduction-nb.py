...
# si ce n'est pas le cas et pour un rendu optimal, installez la librairie `jupyterlab-courselevels`  
# ```bash
...
# ## objectifs de Python-numérique (v1: original)
#
# <br>
#     
...
# %% [markdown] tags=["framed_cell"]
# ## objectifs de Python-numérique (v2: no br)
#
# <br>
#     
# vous êtes désormais capables de lire et d'écrire du code **python simple**
...
# %% [markdown] tags=["framed_cell"]
# ````{admonition} objectifs de Python-numérique (v3: admo)
#
# <br>
#     
# vous êtes désormais capables de lire et d'écrire du code **python simple**
...
# %% [markdown] tags=["framed_cell"]
# ````{admonition} objectifs de Python-numérique (v4: admo & no br)
#
# vous êtes désormais capables de lire et d'écrire du code **python simple**
#
# vous savez le mettre en œuvre dans un **notebook**
...
# %% [markdown] tags=["framed_cell"]
# ## objectifs de Python-numérique (v5: v4 + title2)
#
# ````{admonition} objectifs de Python-numérique
#
# vous êtes désormais capables de lire et d'écrire du code **python simple**
#
# vous savez le mettre en œuvre dans un **notebook**
...
# %% [markdown] tags=["framed_cell"]
# ## objectifs de Python-numérique (v6: v5 minus the extra admo label)
#
# ````{admonition} --
#
# vous êtes désormais capables de lire et d'écrire du code **python simple**
